...
var BLOCKED = /* @__PURE__ */ new Set([
  "TR",
  // Turkey — state monopoly, promotion prosecuted
  "TH",
  // Thailand — gambling illegal
  "VN",
  // Vietnam — gambling illegal
  "ID",
  // Indonesia — gambling illegal
  "PK",
  // Pakistan — gambling illegal
  "BD"
  // Bangladesh — gambling illegal
]);
...
// ../.wrangler/tmp/pages-WIWCER/functionsRoutes-0.019871010350858698.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
